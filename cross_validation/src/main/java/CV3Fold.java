...
public class CV3Fold {
    public static final String COMMA_DELIMITER = ",(?=([^\"]*\"[^\"]*\")*[^\"]*$)";
    public static void main(String[] args) {
        LogManager.getLogger("org").setLevel(org.apache.log4j.Level.OFF);
        SparkConf conf = new SparkConf().setAppName("CV3Fold").setMaster("local[1]");
...
//        RDD<String> input = jsc.textFile("titanic-train.csv", minPartition);
        ...
        JavaRDD<String>[] tmp = data.randomSplit(new double[]{0.333, 0.333, 0.333}, 17);
        ...
        System.out.println("********** 3-fold CV **********");
        System.out.println("Precision=  " + prec);
        System.out.println("Accuracy=  " + accuracy);
        System.out.println("AUC=  " + AUC / 3);
